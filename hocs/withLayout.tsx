...
export function withPublicLayout(Component: NextComponentType, title: string, pageTitle?: string) {
	const appEnvName = process.env.NEXT_PUBLIC_ENVIRONMENT_NAME ? `[${process.env.NEXT_PUBLIC_ENVIRONMENT_NAME}]` : '';
			...
			<Box height="100vh" display="flex" flexDirection="column">
				...
				{!authUser.isEmailVerified && (
					<Alert.Root status="warning" justifyContent="center">
						<Alert.Indicator />
						<Alert.Title>Verifica tu correo electrónico para comenzar a utilizar tu cuenta</Alert.Title>
					</Alert.Root>
				)}
				<Nav />
				<Container maxW="container.xl" pb="2em">
